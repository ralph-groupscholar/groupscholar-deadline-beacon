...
VALUES
    (1, 'slack', datetime('now', '-2 days'), 'Initial reminder scheduled for STEM Bridge Scholars.'),
    (2, 'email', datetime('now', '-5 days'), 'First-Gen Pathways Grant: upcoming deadline reminder.');
